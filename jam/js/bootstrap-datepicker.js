...
//        this.component = this.element.is('.date') ? this.element.find('.add-on') : false;
        ...
        this.daysMin = options.daysMin || this.element.data('date-weekstart') || DPGlobal.dates.daysMin;
        this.months = options.months || this.element.data('date-months') || DPGlobal.dates.months;
        this.monthsShort = options.monthsShort || this.element.data('date-monthsShort') || DPGlobal.dates.monthsShort;
...
//            this.picker.find('.datepicker-days').focus();
        ...
        fillDow: function(){
            ...
            while (dowCnt < this.weekStart + 7) {
                html += '<th class="dow">' + this.daysMin[(dowCnt++)%7] + '</th>';
            }
            html += '</tr>';
        ...
        fillMonths: function(){
            ...
            var i = 0
            while (i < 12) {
                html += '<span class="month">'+this.monthsShort[i++]+'</span>';
            }
