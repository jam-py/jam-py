...
for(i=0;i<details.length;i++){let detail=this.find(details[i]),detail_container=container,height_delta=0;if(details.length>1){detail_container=task.add_tab(container,detail.item_caption,{tab_id:'tab'+i,on_click:tab_changed});height_delta=38;}
