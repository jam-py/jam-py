...
self.refresh(function(){self._do_after_delete_record(master_changing,callback);});});},function(){self.hide_message(mess);},null,{hide:false});}else{this.warning(task.language.no_record);}}}
