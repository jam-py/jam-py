...
catch(e){if(!this.is_changing()){this.edit();}
return;}
...
create_tabs(container){var i,tabs=this.edit_options.tabs;this.task.init_tabs(container,{consistent_height:true});for(i=0;i<tabs.length;i++){this.create_bands(tabs[i],task.add_tab(container,tabs[i].name))}}
