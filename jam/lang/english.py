...
#admin fields
    ...
    'view_template':                    u'View UI',
    'edit_template':                    u'Edit UI',
    'filter_template':                  u'Filter UI',
    'visible':                          u'Visible',
...
#admin messages
    ...
    'field_used_in_filters':            u"Can't delete field %s.\n It's used in filter definitions:\n%s",
    'field_used_in_fields':             u"Can't delete field %s.\n It's used in field definitions:\n%s",
    'field_used_in_indices':            u"Can't delete field %s.\n It's used in index definitions:\n%s",
    'field_is_system':                  u"Can't delete system field.",
    'detail_mess':                      u'%s - detail %s',
    'item_used_in_items':               u"Can't delete item %s.\n It's used in item definitions:\n%s",
    'field_mess':                       u'%s - field %s',
    'item_used_in_fields':              u"Can't delete item %s.\n It's used in field definitions:\n%s",
    'param_mess':                       u'%s - parameter %s',
    'item_used_in_params':              u"Can't delete item %s.\n It's used in param definitions:\n%s",
    'invalid_name':                     u'Name is invalid.',
    'invalid_field_name':               u'Field name is invalid.',
    'type_is_required':                 u'Field type is required.',
    'index_name_required':              u'Index name is required.',
    'index_fields_required':            u'There are no index fields is required.',
    'cant_delete_group':                u"Can't delete group.",
    'object_field_required':            u'An item field is required',
